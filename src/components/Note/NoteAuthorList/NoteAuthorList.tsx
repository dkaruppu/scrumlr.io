...
export const NoteAuthorList = (props: NoteAuthorListProps) => {
  ...
  return props.showAuthors || props.viewer.user.id === stackAuthor.user!.id ? (
    <div className="note-author-list">
      <div className={classNames("note-author__container", "note-author__container--self")}>
        <figure className={classNames("note__author", "note__author--self")} aria-roledescription="author" key={stackAuthor.user!.id}>
          <UserAvatar
        ...
        <div className={classNames("note__author-name", "note__author-name--self")}>{stackAuthor.displayName}</div>
      </div>
      ...
      <div className="note-rest-authors__container">
        ...
        {restUsersExist && (
          <figure className={classNames("note-author-rest", "note-author-rest--self")} title={restUsersTitle}>
            {restAuthors.length}
          </figure>
        )}
      </div>
